...
function setAuthorizedCookies(res, result) {
    res.cookie('uid', result.userId, {httpOnly: true, expires: new Date(Date.now() + 1000 * 86_400 * 10), secure: true, sameSite: 'none', domain:'borodichalex-travel-app.netlify.app'});
    res.cookie('authorized', true, {expires: new Date(Date.now() + 1000 * 86_400 * 10), secure: true, sameSite: 'none', domain: 'borodichalex-travel-app.netlify.app'});
}
